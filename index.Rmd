...
* MIT License `use_mit_license()`: people can do anything they want with your code as long as attributing to you.

* Apache License 2.0 `use_apl2_license()`: similar to MIT, but also provides an express grant of patent rights from contributors to users.

* GPLv3 `use_gpl3_license()`: people who distributes your code or a derivative work to make the source available under the same terms.

* CC0 `use_cc0_license()`: dedicated to public domain. Appropriate for data packages.
...
.footnote[reference: [choose a license](https://choosealicense.com)]
...
## Step 6: explore in console `r icon::fa_arrows_alt_h()` modify code
...
* Shortcut `Cmd/Ctrl` + `Shift` + `B` to build the package
...
## Step 9: pass CRAN check

* Shortcut `Cmd/Ctrl` + `Shift` + `E` to pass CRAN check
